...
<section class="hero">
  ...
  <div class="wrap hero-in">
    <span class="hero-badge">%s <b>%s / 5</b> — %s opinii w Google</span>
  ...
  <div class="wrap">
    ...
    <div class="grid g3">
      ...
      <a class="card reveal" href="zwierzeta-gospodarskie.html" style="text-decoration:none">
        <span class="ic">%s</span>
        <h3>Bydło</h3>
        <p>Opieka nad stadami bydła. Lekarz szkoli się w buiatrii — medycynie bydła.</p>
      </a>
      <a class="card reveal" href="zwierzeta-gospodarskie.html" style="text-decoration:none">
        <span class="ic">%s</span>
        <h3>Konie</h3>
    ...
    <div class="split rev">
      <div class="split-txt reveal">
        ...
        <div class="todo">
          ...
          <p>Uczelnia i rok dyplomu, specjalizacje, kursy, imiona osób z zespołu — uzupełnimy po rozmowie.</p>
        </div>
      </div>
      <div class="split-imgs reveal">
...
<section>
  <div class="wrap">
    <div class="sec-head center reveal">
      ...
      <p class="lead" style="margin:0 auto">Psy, koty, bydło i konie — cztery gatunki, które widać w znaku gabinetu.</p>
    </div>
...
''' % TEL
    ...
    build('psy-i-koty.html',
          'Weterynarz dla psa i kota — Bielsk | Gabinet Mazovet',
...
'''
    ...
    build('zwierzeta-gospodarskie.html',
          'Weterynarz dla bydła i koni — Bielsk | Gabinet Mazovet',
          'Opieka nad bydłem i końmi — gabinet weterynaryjny Mazovet, ul. Sierpecka 48 w Bielsku. Kontakt: 794 206 306.',
...
<section>
  <div class="wrap">
    ...
    <div class="todo" style="margin-top:34px">
      ...
      <p>Najlepiej działają zdjęcia z gabinetu: sala zabiegowa, sprzęt, zespół przy pracy i zadowoleni pacjenci (za zgodą właścicieli). Wystarczy je przesłać — my zajmiemy się obróbką i opisami.</p>
    </div>
  </div>
</section>
''' % figs
